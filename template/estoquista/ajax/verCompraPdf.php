...
$relatorio = utf8_decode("COMPROVANTE DE SOLICITAÇÃO DE PEÇAS");
		...
		$sql->conecta();
			...
			*/
			...
			$ok1 = $sql->consulta ( Relatorio::verCompraPdf( $datapedido ) );
			...
			while ( $l = $sql->resultado() ) {
				...
				if (($j % 2) == 1) {
					...
					$pdf->Cell(40,7,data_dmy( $datapedido ),1,0,'C',1);
					$pdf->Cell(70,7,$l['nomepeca'],1,0,'C',1);
					$pdf->Cell(40,7,$l['qtd'],1,0,'C',1);
					$pdf->Cell(40,7,strtoupper( $l['status'] ),1,0,'C',1);
			        $pdf->Ln();
			...
			$pdf->Ln();
			$pdf->SetX(42);
			$pdf->Cell(30,7,$_SESSION['nome'],0,0,'C',1);
